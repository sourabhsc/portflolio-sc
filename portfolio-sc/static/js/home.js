$(function() {
  ...
  $(".typed").typed({
    strings: [
      ...
      "><span class='caret'>$</span> hobbies: Badminton, Travel, <a href='http://www.rish.space/blog'>writing</a><br/> ^300" +
      "><span class='caret'>$</span> alias: sourabhsc <br/>" +
      "><span class='caret'>$</span> highlight:  <a href='/projects/NULIRG'>Image segmentation on HST ULIRGs</a>, <a href='/projects/dharavicovid'>A JHU covid challenge solution</a><br/>"/*
